...
legend(10, 0.7, legend=c("LM","GRF","GRF.AllFeatures","GRF.CountyFeatures","SLM","GRF.block","GRF.block0","GRF.block6"), col=c("gray", "green", "blue","white","red","purple","magenta","cyan"), lty=1:6, cex=0.8)
